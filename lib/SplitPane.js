    ...
    var SplitPane = function (_Component) {
        ...
        SplitPane.prototype.onResizeStart = function onResizeStart() {
            ...
            this.panes = this.state.children.filter(function (child) {
                ...
                var _child$props$min = _child$props.min;
                var min = _child$props$min === undefined ? 0 : _child$props$min;
                var _child$props$max = _child$props.max;
                var max = _child$props$max === undefined ? Number.MAX_VALUE : _child$props$max;
        ...
        SplitPane.prototype.onResize = function onResize(index, delta) {
            ...
            panes = this.panes = panes.map(function (pane, i) {
                var node = pane.node;
                var rest = babelHelpers.objectWithoutProperties(pane, ['node']);
        ...
        SplitPane.prototype.render = function render() {
            ...
            var rest = babelHelpers.objectWithoutProperties(_props2, ['direction']);
            var _state = this.state;
            var resizing = _state.resizing;
